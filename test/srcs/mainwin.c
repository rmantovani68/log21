...
void lista_activated(GSimpleAction *action, GVariant *parameter, gpointer win)
{
    ...
    gtk_stack_set_visible_child ( GTK_STACK(priv->stack_main), priv->sw_main);
}
...
static void test_activated (GSimpleAction *action, GVariant *parameter, gpointer win)
{
    TestWindow *w;

    w = test_window_new (MAIN_WINDOW (win));
    gtk_window_present (GTK_WINDOW (w));
}
...
static GActionEntry entries[] =
{
    ...
    { "test",                 test_activated,               NULL, NULL, NULL },
...
static void main_window_class_init (MainWindowClass *class)
{
    ...
    gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), MainWindow, pb_aggiorna);
    gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), MainWindow, pb_test    );
    ...
    gtk_widget_class_bind_template_child_private (GTK_WIDGET_CLASS (class), MainWindow, sw_main    );
