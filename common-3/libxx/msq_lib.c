...
/******************************************************************************
  FUNCTION: int PackMsg(char *msg, int dest, int srce, int ack, int stat,
                   int _class, int code, char *info, int info_len)
...
******************************************************************************/
int PackMsg(char *msg, int dest, int srce, int ack, int stat, int _class,
			int code, char *info, int info_len)
{
	...
	PutField(ptr->_class, _class, CLASS_LEN);
...
int PackStructMsg(char *msg, MSGHDRINT *msghdr, char *info, int info_len)
{
	...
	/* Insert message class */
	PutField(ptr->_class, msghdr->_class, CLASS_LEN);
...
******************************************************************************/
int UnpackMsg(char *msg, int *dest, int *srce, int *ack, int *stat, int *_class,
				int *code, int *rcvserial, char *info, int len)
{
	...
	*stat = GetField(ptr->stat, STAT_LEN);
	...
	/* Insert message class */
	*_class = GetField(ptr->_class, CLASS_LEN);
...
int UnpackStructMsg(char *msg, MSGHDRINT *msghdr, char *info, int len)
{
	...
	/* Insert message class */
	msghdr->_class = GetField(ptr->_class, CLASS_LEN);
