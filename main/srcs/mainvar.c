...
DBSTRUCT tCorrAgg;    /* Export Dati Corriere - Aggiuntivo */
...
DBSTRUCT tFlussoCedola;    /* flusso cedola */
#endif
...
CFGITEM CFGItems[] =  {
    ...
    {"General Settings",  "ChiusuraCollo",                 CFG_TYPE_INT,    {pnInt:&Cfg.nChiusuraCollo         },    {nInt:     1},                           CFG_NO_WIDGET,            ""},        
    {"General Settings",  "ImballiUbicati",                CFG_TYPE_INT,    {pnInt:&Cfg.nImballiUbicati        },    {nInt:     0},                           CFG_NO_WIDGET,            ""},        
    {"General Settings",  "StampaRAC",                     CFG_TYPE_INT,    {pnInt:&Cfg.nStampaRAC             },    {nInt:     0},                           CFG_NO_WIDGET,            ""},        
