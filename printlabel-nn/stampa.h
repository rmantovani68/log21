...
int InitData(char *pszDataType,char *pszString,int nRow,int nColulmn,BOOL bIncremental);
int PrintRow(char *pszRow,int nSkip,BOOL bA4);
BOOL PrintField(char *pszField,int nRow,int nColumn);
...
* Internal functions
*/
void FillData(LINKED_LIST *List,char *pszString,int nRow,int nColumn,BOOL bIncrement);
