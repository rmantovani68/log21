...
/*	
* rm 17-03-2004 kernel 2.4.22-1.2115.nptl :
*               modificata la chiamata alla funzione remap_page_range a causa di diverso prototipo 
*/
...
int ioscni_init_module(void)
{
  int rv,i;

  SET_MODULE_OWNER(&ioscni_fops);
...
void ioscni_cleanup_module(void)
{
  int i;
