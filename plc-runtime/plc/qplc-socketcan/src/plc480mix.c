/* ALLINEAMI ! */
char ver_user[] = "2.2.mix.1\t\t[14/07/1997 17:21:09]";
/*
* @(#) plc480.c 2.2.mix.1 Mon Jul 14 17:23:20 MET DST 1997
*
...
* 29/11/96 GG 2.0.mix Versione "mix", da utilizzare come primo oggetto nel
*             link di un programma IL, qualora si desideri ottenere un modulo
*             "user.oo" capace di caricare ed eseguire, in parallelo, anche
*             un programma "prog.oo" in stile 480. L'oggetto "plc480mix.o"
*             deve essere il primo della lista di link, seguito da "ilc0mix.o",
*             che prende il posto di "ilc0.o" (vedere ~/ilc/runtm/loader).
* 09/01/97 GG 2.1.mix Aggiunta la chiamata ad una funzione opzionale
*             di inizializzazione a livello di programma 480.
* 15/01/97 GG 2.2.mix Aggiunto l'aggiornamento dell'indice del programma
*             corrente (gestione provvisoria).
* 14/07/97 GG 2.2.mix.1 Sostituite le "sprintf" con "util_safe_sprintf".
*/
...
extern int MIX_UserStart(int * code);
extern int MIX_UserMain(int start);
extern void MIX_UserStop(void);
