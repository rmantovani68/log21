/*
* @(#) plcapi.h 2.2 Mon Jan 22 10:44:33 MET 2001
*
...
* 28/07/00 GG 2.1 Aggiustamenti per compilazione su Linux.
* 22/01/01 GG 2.2 Allineamento ai nuovi prototipi in services.h.
*/
...
#ifdef ID_SDM_USE_SDMCONN
extern PTSDMCONN MData;
#else
extern char * MData;
#endif
