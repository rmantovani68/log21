...
/*
* @(#) vmsgv.c 1.0 Thu Jul 13 20:00:42 MET DST 2000
*
*  Codifica dei blocchi funzionali CNi per emissione di messaggi
* codificati come interi. Funziona solo con versioni di "QUOTE" scritte
* dopo l'11/2/97.
*
...
long VMSGV(register struct plc_vmsgv_t * st)
{
register long c,v;
