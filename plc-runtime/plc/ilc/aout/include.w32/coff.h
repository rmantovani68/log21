...
#ifdef M88K
#define E_COFFMAGIC	0x161
#define COFFMAGIC	0x16d		/* Magic no. for M88K */
#else
...
#ifdef __mips__
	long		bss_start;	/* base of bss for this file */
	long		gprmask;	/* Register mask */
	long		cprmask[4];	/* Coprocessor register masks */
	long		gp_value;	/* Global pointer value */
#endif /* mips */
#if defined(rs6000) || defined(__powerpc__)
...
#ifdef M88K
#define F_AR32W		0001000		/* 32 bit word */
...
#ifdef M88K
	long		s_nreloc;	/* no. of relocation entries */
	union {
		long	_s_nlnno;	/* no. of line no. entries */
		long	_s_vendor;	/* for .vendor section */
	} _s_s;
#else
...
#define STYP_BSS	0x80		/* small bss section */
#define STYP_RDATA	0x100		/* read only data section */
#define STYP_SDATA	0x200		/* small data section */
#define STYP_SBSS	0x400		/* bss section */
#define STYP_UCODE	0x800		/* ucode section */
#define STYP_LIT8	0x08000000	/* 8 byte literal section */
#define STYP_LIT4	0x10000000	/* 4 byte literal section */
#define STYP_LIB	0x40000000	/* lib section */
#define STYP_INIT	0x80000000	/* .init section */
#define STYP_NRELOC_OVFL	0x10000000	/* s_nreloc overflowed */
#else
#define STYP_TEXT	0x20		/* executable text section */
#define STYP_DATA	0x40		/* initialized data section */
...
#else
	unsigned short	r_type;		/* relocation type - see below */
#endif
#if defined(TSUNAMI)
...
#ifdef M88K
	unsigned short	r_offset;	/* high 16 bits of offset */
#endif
};
...
#else
#define R_PCR16L	128		/* PC-relative 16 bit reference */
#define R_PCR26L	129		/* PC-relative 26 bit reference */
#define R_VRT16		130		/* Direct 16 bit reference */
#define R_HVRT16	131		/* Direct High 16 bit reference */
#define R_LVRT16	132		/* Direct Low 16 bit reference */
#define R_VRT32		133		/* Direct 32 bit reference */
#endif
...
#ifdef M88K
	unsigned long	l_lnno;		/* line number - M88K OCS */
#else
...
#define C_EFCN		-1		/* physical end of function - M88K OCS */
#define C_NULL		0
...
#ifdef M88K /* OCS */
	union {
		char x_fname[FILNMLEN];	/* old COFF */
		struct {
			long _x_zeroes;		/* 0 if name is in the string table */
...
#ifdef M88K
#define AUXESZ		20		/* Size of this union should be 20 */
#else
#if defined(SPARC) || defined(__SPARC__)
#define AUXESZ		sizeof(union auxent)
#else
#define AUXESZ		18		/* Size of this union should be 18 */
#endif /* SPARC || __SPARC__ */
#endif
