...
ps -ax  | while read a b c d e; do case "$e" in */volum*) echo kill -15 $a; kill -15 $a;;  esac; done 
ps -ax  | while read a b c d e; do case "$e" in */settori*) echo kill -15 $a; kill -15 $a;;  esac; done 
ps -ax  | while read a b c d e; do case "$e" in */ios*) echo kill -15 $a; kill -15 $a;;  esac; done 
ps -ax  | while read a b c d e; do case "$e" in */receive*) echo kill -15 $a; kill -15 $a;;  esac; done 
