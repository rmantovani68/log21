...
ncftpput -u $Ftp_User -p $Ftp_Password -t 300 $Ftp_Host $Remote_Dir $First_File
Ftp_Exit_Status=$?
...
echo $Message
echo "insert into ftp_send_log (message,code) values ('$Message',$Ftp_Exit_Status)"|psql -h database mondadori 
