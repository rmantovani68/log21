#!/bin/bash
#cd /u/prj/mondadori/exe;./main

PS_AX=$(ps ax)
#echo -e $PS_AX
MAIN_PROCESS=-1

#ps ax  | while read a b c d e f g h i l; do case "$e$g" in */main1* ) echo trovato $a $e $f $g $h $i $l; TROV='yes'; kill -15 $a;;  esac; done
##ipcs -q | while read a b c; do case "$a" in 0x00001001) echo ipcrm msg $b; ipcrm msg $b ; ;;  esac; done
#cd /u/prj/inco/exe
#./main -t 1 -m -r
