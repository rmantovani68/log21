...
cd /u/prj/deltastock/export/rese_flussi_colli
FN=$(find . -iregex './researrivate[0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9][0-9].txt'| head -1)
echo $FN
...
then
  ...
  /usr/local/bin/ftp_sender.sh --ftpuser boxline --ftppassword boxline --ftphost ftp.mondadori-franchising.it --remotedir . --filename /u/prj/deltastock/export/rese_flussi_colli/$File_Name --backupdir /u/prj/deltastock/export/rese_flussi_colli/backup
